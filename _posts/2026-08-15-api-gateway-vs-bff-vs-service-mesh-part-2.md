...
- Architecture
date: 2026-08-15
seo_title: "API Gateway vs BFF vs service mesh responsibilities (Part 2) - Advanced Guide"
seo_description: "Advanced practical guide on api gateway vs bff vs service mesh responsibilities (part 2) with architecture decisions, trade-offs, and production patterns."
tags: [java, microservices, distributed-systems, architecture, backend]
canonical_url: "https://sandeepbhardwaj.github.io/2026-08-15-api-gateway-vs-bff-vs-service-mesh-part-2/"
...
# API Gateway vs BFF vs service mesh responsibilities (Part 2)

This post covers production-focused design decisions for **API Gateway vs BFF vs service mesh responsibilities (Part 2)**.
...
- API Gateway vs BFF vs service mesh responsibilities (Part 2) should be implemented as an **operational pattern**, not only a code pattern.
