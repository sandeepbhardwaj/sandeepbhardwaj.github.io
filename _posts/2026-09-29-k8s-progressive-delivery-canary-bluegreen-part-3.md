...
- Backend
date: 2026-09-29
seo_title: "Progressive delivery: canary and blue-green in production (Part 3) - Advanced Guide"
seo_description: "Advanced practical guide on progressive delivery: canary and blue-green in production (part 3) with architecture decisions, trade-offs, and production patterns."
tags: [kubernetes, platform-engineering, reliability, backend, operations]
canonical_url: "https://sandeepbhardwaj.github.io/2026-09-29-k8s-progressive-delivery-canary-bluegreen-part-3/"
...
# Progressive delivery: canary and blue-green in production (Part 3)

This post covers production-focused design decisions for **Progressive delivery: canary and blue-green in production (Part 3)**.
...
- Progressive delivery: canary and blue-green in production (Part 3) should be implemented as an **operational pattern**, not only a code pattern.
